...
The API Worker binds its own resolved URL during initialization for Better Auth.
The stack supplies the resolved Web URL to avoid a cross-resource dependency cycle.
